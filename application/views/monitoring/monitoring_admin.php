...
<div id="header_part">
  	<div id="header_pic">
	  	<img id="himage" src="<?php echo base_url(); ?>images/headerpics/header_monitoring.jpg" />
    </div>
  </div>
					...
					<div style="width:985px; height:600px;">
                    	<div style="position:absolute; background-color:#DDDDDD; width:245px; height:600px; border-right-style:solid; border-right-width:thin">
							...
							<?php 
								...
								if($cookie[2]==10) {
							?>
                            <div id="faci_tab" class="panel_tab" onclick="selectPanelTab('faci_tab')">Facilitators</div>
                            <div id="com_tab" class="panel_tab" onclick="selectPanelTab('com_tab')">Committees</div>
                            <div id="term_tab" class="panel_tab" onclick="selectPanelTab('term_tab')">Term Management</div>
                            <div id="bs_tab" class="panel_tab" onclick="selectPanelTab('bs_tab')">Bible Study Groups</div>
                            <div id="classes_tab" class="panel_tab" onclick="selectPanelTab('classes_tab')">Classes</div>
                            <?php } ?>
                        </div>
                        <div style="position:absolute; left:250px; background-color:#EEEEEE; width:735px; height:600px; border-left-style:solid; border-left-width:thin;">
                            ...
                            <div id="tab_content" style="padding:10px; overflow:auto; width:715px; height:580px;">
                            	<?php include('admin/updates_tab.php'); ?>
                            </div>
                        </div>
                    </div>
				</span>
...
<?php $this->load->view('monitoring/footer'); ?>